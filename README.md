...
- 当前 `Wave 1` repo-side 已完成 `W1-T01 ~ W1-T05` 的 fake-first 主机侧薄切片，新增落点为 `runtime/host-orchestrator/`
- 当前 `Wave 1` 仍未 accepted：尚未做 live `Codex SDK` 真机执行验收，`W1-T06 / W1-T07` 也未完成
