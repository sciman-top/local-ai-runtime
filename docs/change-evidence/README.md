...
- [20260716 Local AI Runtime v3.25 Environment-Proof Rebaseline](20260716-local-ai-runtime-v3.25-environment-proof-rebaseline.md): freezes v3.24 candidate/package/plan bytes, replaces impossible pre-resume child observation with parent proof plus post-resume no-write Q0 observation, carries seven exact compatible artifacts, reduces the current graph to 52 tasks, and keeps approval/runtime/live effects inactive.
...
- [20260714 LAR-P0A-004 Product And Submission](20260714-lar-p0a-004-product-submission.md): closes work-class-only Native/Batch routing, closed template/submission parameters, permanent generation-0 root replay and atomic resubmission without adding a planner or runtime model router.
...
- [20260716 Local AI Runtime v3.25 Environment-Proof Rebaseline](D:/CODE/local-ai-dev-orchestrator/docs/change-evidence/20260716-local-ai-runtime-v3.25-environment-proof-rebaseline.md) - 当前候选规划真值；v3.25/Lineage.v4、两阶段 environment proof、52 项 v4 DAG、B3 deferred 与非批准边界
- [20260716 Local AI Runtime v3.24 Product/Toolchain Rebaseline](D:/CODE/local-ai-dev-orchestrator/docs/change-evidence/20260716-local-ai-runtime-v3.24-product-toolchain-rebaseline.md) - predecessor product/toolchain successor history；v3.24/Lineage.v3、exact toolchain、first-launch product experience、55 项 archived DAG 与非批准边界
...
- [20260712 Baseline Candidate Entry Guard](D:/CODE/local-ai-dev-orchestrator/docs/change-evidence/20260712-local-ai-runtime-baseline-entry-guard.md) - 无版本稳定入口是非规范、非批准输入；当前目标身份由 v3.25 rebaseline 和 planning verifier 约束，原 evidence 只记录入口机制的首次建立。
...
- [20260708 Non-Host-Local Runner Acceptance Schema](D:/CODE/local-ai-dev-orchestrator/docs/change-evidence/20260708-non-host-local-runner-acceptance-schema.md)
