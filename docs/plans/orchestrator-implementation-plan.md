...
- next: `remote_non_gui` promotion evidence（`P5-T01` repo-side `leases / route / quota` 与 `P5-T02` deterministic multi-worker simulation 已收口；branch deletion 仍不自动化；live planner/review sidecar 仍未接线）
