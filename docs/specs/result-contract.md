...
- 只有当 live planner/review sidecar 与 non-host_local runner 真接线后，才结合 parity / runner 的真实稳定性重新评估 schema rename
...
- 只有在 live planner/review sidecar 与 non-host_local runner 真接线后，才重新评估是否需要 rename
