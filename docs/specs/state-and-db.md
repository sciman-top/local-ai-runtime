...
- `remote_non_gui` promotion suite 已可在单机上复放默认 local-profile lane mismatch 与 explicit remote-profile fail-closed handoff 的 repo-side summary，并读取 `handoff_reason_codes / worker_execution_attempted`；当前仍未落 remote runner
