...
- repo-owned `host_local` task entrypoint 只是当前主线 runtime 接线，不等于 live planner/review sidecar、non-host_local runner、`platform compatibility green`、或 `live accepted`
